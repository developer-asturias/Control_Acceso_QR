<?php
                                    ...
                                    <tr>
                                        <td align="center" style="color: #000; font-size: 16px; font-family: Quicksand, Calibri, sans-serif; line-height: 24px;">
                                            ...
                                            <div style="line-height: 24px;">
                                                ...
                                                <img width="100" border="0" style="display: block; width: 300px;" src="https://asturias.systemsolutions.com.co/Archivos/'.$indice.'.png" alt="" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
    ...
    $mail->Password = "zavndqlxxvbzulys";

    $mail->setFrom("servicioalestudiante@asturias.edu.co", "Ceremonia de Graduación Asturias");
    $mail->AddReplyTo('accesoasturias@gmail.com','Ceremonia de Graduación Asturias');
